...
# --------------------------
DATASET_PATH = "${PROJECT_ROOT}/test_C-CoT/cot_generated_first100_flat_labeled_depth5.jsonl"
MODEL_NAME = "${MODEL_DIR}/Llama-2-7b-chat-hf"
SAVE_PATH = "${PROJECT_ROOT}/baseline/LLama/ccot_seq_model.pt"
