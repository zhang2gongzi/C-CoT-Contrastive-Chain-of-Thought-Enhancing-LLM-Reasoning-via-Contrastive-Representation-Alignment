...
# ==============================================================================
CONFIG = {
    "llama_model_path": "${MODEL_DIR}/Llama-2-7b-chat-hf",
    "trained_proj_path": "${PROJECT_ROOT}/baseline/LLama/ccot_seq_model.pt",
    "train_data_path": "${PROJECT_ROOT}/test_C-CoT/cot_generated_first100_flat_labeled_depth5.jsonl",
    "test_data_path": "${PROJECT_ROOT}/test_C-CoT/cot_generated_first100_flat_labeled_depth5.jsonl",
    "save_classifier_path": "${PROJECT_ROOT}/baseline/LLama/cot_correctness_classifier.pt",
    "max_len": 400,
    "batch_size": 4,
    "epochs": 10,
    "lr": 1e-4,
