...
# 配置
# ======================
LLAMA_PATH = "${MODEL_DIR}/../model_eval/modelscope_models/Qwen/Qwen-7B-Chat"
DATA_PATH = "${PROJECT_ROOT}/database/bamboogle/test-00000-of-00001-fd9def31e0acf72c.parquet"
NUM_SAMPLES = 200
