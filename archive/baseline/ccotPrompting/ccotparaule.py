...
# --------- 配置 -------------
DATASET_PATH = "${PROJECT_ROOT}/../ChatLogic/PARARULE-Plus/Depth5/PARARULE_Plus_Depth5_shuffled_dev_huggingface.jsonl"
MODEL_PATH = "${MODEL_DIR}/Qwen2.5-7B-Instruct"
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
OUTPUT_FILE = "${PROJECT_ROOT}/baseline/ccotPrompting/depth5_contrastive_cot_results.jsonl"
# ----------------------------
