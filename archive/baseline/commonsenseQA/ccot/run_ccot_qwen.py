...
# 配置路径
# =======================
INPUT_PATH = "${PROJECT_ROOT}/baseline/commonsenseQA/ccot/generated_paths/commonsenseqa_qwen7b_paths.jsonl"
PROTOTYPE_PATH = "${PROJECT_ROOT}/baseline/commonsenseQA/ccot/prototype/positive_prototype.npy"
OUTPUT_RESULT_PATH = "${PROJECT_ROOT}/baseline/commonsenseQA/ccot/results/cot_results.json"

os.makedirs(os.path.dirname(OUTPUT_RESULT_PATH), exist_ok=True)

# 使用 BERT 模型
MODEL_NAME = "${MODEL_DIR}/bert-base-uncased"
