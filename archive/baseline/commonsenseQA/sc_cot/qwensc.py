...
# -------------------------- 1. 路径与参数配置 --------------------------
MODEL_PATH = "${MODEL_DIR}/../model_eval/modelscope_models/Qwen/Qwen-7B-Chat"  # Qwen模型路径
DATA_PATH = "${PROJECT_ROOT}/database/commonsenseQA/train-00000-of-00001.parquet"  # 数据集路径
OUTPUT_DIR = "${PROJECT_ROOT}/baseline/commonsenseQA/sc_cot/qwen_sc_results"  # 结果保存目录（与Llama区分）
