...
# 2. 数据路径（替换为你的数据实际路径）
DATA_PATH = "${PROJECT_ROOT}/test_C-CoT/cot_generated_first100_flat_labeled_depth5.jsonl"  # 你的JSON Lines文件

# 3. 模型配置
BERT_MODEL_NAME = "${MODEL_DIR}/bert-base-uncased"  # 预训练模型（可换bert-large-uncased）
...
# 6. 保存与日志配置
SAVE_MODEL = True
MODEL_SAVE_PATH = "${PROJECT_ROOT}/baseline/onlyInfoNCE/saved_model/infonce_best.pt"  # 模型保存路径
