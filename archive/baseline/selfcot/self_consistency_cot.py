...
class Config:
    ...
    # 数据路径
    RAW_DATA_PATH = "${PROJECT_ROOT}/../ChatLogic/PARARULE-Plus/Depth5/PARARULE_Plus_Depth5_shuffled_dev_huggingface.jsonl"
...
# 保存结果
def save_results(results, metrics, output_file="${PROJECT_ROOT}/baseline/selfcot/depth5_self_consistency_results.json"):
    """保存实验结果和评估指标"""
    output = {
        "config": {
