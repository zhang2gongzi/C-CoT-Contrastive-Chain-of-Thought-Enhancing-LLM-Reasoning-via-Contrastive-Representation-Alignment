...
系统、可复现且能说服审稿人的实验方案。每一项都对应一个假设，并包含具体的数据集、基线、指标、消融设计与可视化/人判评估建议。
...
其中${PROJECT_ROOT}/repr_cache_qwen7b参数为POOL_LAST_N_LAYERS = 4
结果如下
![alt text](repr_cache_qwen7b/viz/tsne_is_correct.png)
${PROJECT_ROOT}/repr_cache_qwen7b_8b参数为POOL_LAST_N_LAYERS = 8
![alt text](image-1.png)
${PROJECT_ROOT}/repr_cache_qwen7b_clear
参数为POOL_LAST_N_LAYERS = 8
使用数据集为${PROJECT_ROOT}/test_C-CoT/first10_flat_labeled_onlysaveclearly.jsonl，这个数据集是只保留了有明确思维链或是yes or no的回答
...
- 脚本路径错误：若验证时调用的脚本路径（`${PROJECT_ROOT}/../ChatLogic/pyDatalog_processing.py`）与实际路径不一致，或脚本被修改、删除，会导致验证逻辑失效（返回默认“无效”）；
...
## 之后测试${PROJECT_ROOT}/includeaccindataset.py
...
![alt text](image.png)
 python3 ${PROJECT_ROOT}/baseline/ccotPrompting/ccotparaule.py
Loading model from ${MODEL_DIR}/Qwen2.5-7B-Instruct...
...
esults saved to ${PROJECT_ROOT}/baseline/ccotPrompting/contrastive_cot_fixed_results.jsonl
...
python3 ${PROJECT_ROOT}/baseline/onlyInfoNCE/main.py
准备数据...
...
✅ 保存最佳模型到 ${PROJECT_ROOT}/baseline/onlyInfoNCE/saved_model/infonce_best.pt（Val Loss: 0.8337）
...
✅ 保存最佳模型到 ${PROJECT_ROOT}/baseline/onlyInfoNCE/saved_model/infonce_best.pt（Val Loss: 0.7507）

=== Epoch 4/10 ===
Epoch  4 | Batch  10/20 | Loss: 0.6625
Epoch  4 | Batch  20/20 | Loss: 0.6094
Val Loss: 0.4765 | Cot Correct Rate: 0.4250
✅ 保存最佳模型到 ${PROJECT_ROOT}/baseline/onlyInfoNCE/saved_model/infonce_best.pt（Val Loss: 0.4765）

=== Epoch 5/10 ===
Epoch  5 | Batch  10/20 | Loss: 0.4428
Epoch  5 | Batch  20/20 | Loss: 0.4433
Val Loss: 0.3812 | Cot Correct Rate: 0.4250
✅ 保存最佳模型到 ${PROJECT_ROOT}/baseline/onlyInfoNCE/saved_model/infonce_best.pt（Val Loss: 0.3812）
...
样本1/200（0.5%）：正确答案=18, 预测答案=32, 是否正确=×, 耗时=13.63s
样本2/200（1.0%）：正确答案=3, 预测答案=3, 是否正确=√, 耗时=10.10s
样本3/200（1.5%）：正确答案=70000, 预测答案=0, 是否正确=×, 耗时=11.08s
样本4/200（2.0%）：正确答案=540, 预测答案=540, 是否正确=√, 耗时=10.38s
样本5/200（2.5%）：正确答案=20, 预测答案=3, 是否正确=×, 耗时=14.85s
样本6/200（3.0%）：正确答案=64, 预测答案=16, 是否正确=×, 耗时=11.03s
样本7/200（3.5%）：正确答案=260, 预测答案=4, 是否正确=×, 耗时=10.70s
样本8/200（4.0%）：正确答案=160, 预测答案=100, 是否正确=×, 耗时=11.47s
样本9/200（4.5%）：正确答案=45, 预测答案=4, 是否正确=×, 耗时=12.64s
样本10/200（5.0%）：正确答案=460, 预测答案=460, 是否正确=√, 耗时=11.18s
样本11/200（5.5%）：正确答案=366, 预测答案=466, 是否正确=×, 耗时=11.18s
样本12/200（6.0%）：正确答案=694, 预测答案=794, 是否正确=×, 耗时=11.35s
样本13/200（6.5%）：正确答案=13, 预测答案=5, 是否正确=×, 耗时=11.37s
样本14/200（7.0%）：正确答案=18, 预测答案=2, 是否正确=×, 耗时=11.29s
样本15/200（7.5%）：正确答案=60, 预测答案=60, 是否正确=√, 耗时=11.08s
样本16/200（8.0%）：正确答案=125, 预测答案=4, 是否正确=×, 耗时=12.46s
样本17/200（8.5%）：正确答案=230, 预测答案=230, 是否正确=√, 耗时=10.92s
样本18/200（9.0%）：正确答案=57500, 预测答案=500, 是否正确=×, 耗时=11.08s
样本19/200（9.5%）：正确答案=7, 预测答案=4, 是否正确=×, 耗时=10.17s
样本20/200（10.0%）：正确答案=6, 预测答案=4, 是否正确=×, 耗时=11.29s
样本21/200（10.5%）：正确答案=15, 预测答案=24, 是否正确=×, 耗时=11.43s
样本22/200（11.0%）：正确答案=14, 预测答案=8, 是否正确=×, 耗时=10.85s
样本23/200（11.5%）：正确答案=7, 预测答案=5, 是否正确=×, 耗时=11.20s
样本24/200（12.0%）：正确答案=8, 预测答案=0, 是否正确=×, 耗时=10.64s
样本25/200（12.5%）：正确答案=26, 预测答案=26.0, 是否正确=√, 耗时=10.58s
样本26/200（13.0%）：正确答案=2, 预测答案=50, 是否正确=×, 耗时=11.46s
样本27/200（13.5%）：正确答案=243, 预测答案=3, 是否正确=×, 耗时=11.57s
样本28/200（14.0%）：正确答案=16, 预测答案=60, 是否正确=×, 耗时=11.28s
样本29/200（14.5%）：正确答案=25, 预测答案=40, 是否正确=×, 耗时=10.80s
样本30/200（15.0%）：正确答案=104, 预测答案=5, 是否正确=×, 耗时=11.56s
样本31/200（15.5%）：正确答案=109, 预测答案=10, 是否正确=×, 耗时=10.46s
样本32/200（16.0%）：正确答案=80, 预测答案=90, 是否正确=×, 耗时=11.21s

开始测评：200条样本，5条路径/样本
样本1/200（0.5%）：真实=1, 预测=1, √
样本2/200（1.0%）：真实=0, 预测=1, ×
样本3/200（1.5%）：真实=1, 预测=1, √
样本4/200（2.0%）：真实=0, 预测=1, ×
样本5/200（2.5%）：真实=1, 预测=1, √
样本6/200（3.0%）：真实=0, 预测=1, ×
样本7/200（3.5%）：真实=1, 预测=1, √
样本8/200（4.0%）：真实=0, 预测=1, ×
样本9/200（4.5%）：真实=1, 预测=0, ×
样本10/200（5.0%）：真实=0, 预测=1, ×
样本11/200（5.5%）：真实=1, 预测=1, √
样本12/200（6.0%）：真实=0, 预测=1, ×
样本13/200（6.5%）：真实=1, 预测=1, √
样本14/200（7.0%）：真实=0, 预测=1, ×
样本15/200（7.5%）：真实=1, 预测=1, √
样本16/200（8.0%）：真实=0, 预测=0, √
样本17/200（8.5%）：真实=1, 预测=0, ×
样本18/200（9.0%）：真实=0, 预测=0, √
样本19/200（9.5%）：真实=1, 预测=0, ×
样本20/200（10.0%）：真实=0, 预测=无, ×
样本21/200（10.5%）：真实=1, 预测=1, √
样本22/200（11.0%）：真实=0, 预测=0, √
样本23/200（11.5%）：真实=1, 预测=1, √
样本24/200（12.0%）：真实=0, 预测=0, √
样本25/200（12.5%）：真实=1, 预测=1, √
样本26/200（13.0%）：真实=0, 预测=1, ×
样本27/200（13.5%）：真实=1, 预测=1, √
样本28/200（14.0%）：真实=0, 预测=0, √
样本29/200（14.5%）：真实=1, 预测=1, √
样本30/200（15.0%）：真实=0, 预测=0, √
样本31/200（15.5%）：真实=1, 预测=0, ×
样本32/200（16.0%）：真实=0, 预测=1, ×
样本33/200（16.5%）：真实=1, 预测=1, √
样本34/200（17.0%）：真实=0, 预测=1, ×
样本35/200（17.5%）：真实=1, 预测=1, √
样本36/200（18.0%）：真实=0, 预测=0, √
样本37/200（18.5%）：真实=1, 预测=1, √
样本38/200（19.0%）：真实=0, 预测=1, ×
样本39/200（19.5%）：真实=1, 预测=1, √
样本40/200（20.0%）：真实=0, 预测=1, ×
样本41/200（20.5%）：真实=1, 预测=1, √
样本42/200（21.0%）：真实=0, 预测=1, ×
样本43/200（21.5%）：真实=1, 预测=1, √
样本44/200（22.0%）：真实=0, 预测=1, ×
样本45/200（22.5%）：真实=1, 预测=1, √
样本46/200（23.0%）：真实=0, 预测=1, ×
样本47/200（23.5%）：真实=1, 预测=1, √
样本48/200（24.0%）：真实=0, 预测=1, ×
样本49/200（24.5%）：真实=1, 预测=0, ×
样本50/200（25.0%）：真实=0, 预测=1, ×
样本51/200（25.5%）：真实=1, 预测=1, √
样本52/200（26.0%）：真实=0, 预测=1, ×
样本53/200（26.5%）：真实=1, 预测=1, √
样本54/200（27.0%）：真实=0, 预测=1, ×
样本55/200（27.5%）：真实=1, 预测=1, √
样本56/200（28.0%）：真实=0, 预测=1, ×
样本57/200（28.5%）：真实=1, 预测=1, √
样本58/200（29.0%）：真实=0, 预测=1, ×
样本59/200（29.5%）：真实=1, 预测=1, √
样本60/200（30.0%）：真实=0, 预测=1, ×
样本61/200（30.5%）：真实=1, 预测=1, √
样本62/200（31.0%）：真实=0, 预测=1, ×
样本63/200（31.5%）：真实=1, 预测=1, √
样本64/200（32.0%）：真实=0, 预测=1, ×
样本65/200（32.5%）：真实=1, 预测=1, √
样本66/200（33.0%）：真实=0, 预测=1, ×
样本67/200（33.5%）：真实=1, 预测=1, √
样本68/200（34.0%）：真实=0, 预测=1, ×
样本69/200（34.5%）：真实=1, 预测=1, √
样本70/200（35.0%）：真实=0, 预测=1, ×
样本71/200（35.5%）：真实=1, 预测=1, √
样本72/200（36.0%）：真实=0, 预测=1, ×
样本73/200（36.5%）：真实=1, 预测=1, √
样本74/200（37.0%）：真实=0, 预测=0, √
样本75/200（37.5%）：真实=1, 预测=1, √
样本76/200（38.0%）：真实=0, 预测=1, ×
样本77/200（38.5%）：真实=1, 预测=1, √
样本78/200（39.0%）：真实=0, 预测=1, ×
样本79/200（39.5%）：真实=1, 预测=1, √
样本80/200（40.0%）：真实=0, 预测=1, ×
样本81/200（40.5%）：真实=1, 预测=1, √
样本82/200（41.0%）：真实=0, 预测=1, ×
样本83/200（41.5%）：真实=1, 预测=1, √
样本84/200（42.0%）：真实=0, 预测=1, ×
样本85/200（42.5%）：真实=1, 预测=1, √
样本86/200（43.0%）：真实=0, 预测=1, ×
样本87/200（43.5%）：真实=1, 预测=1, √
样本88/200（44.0%）：真实=0, 预测=1, ×
样本89/200（44.5%）：真实=1, 预测=1, √
样本90/200（45.0%）：真实=0, 预测=1, ×
样本91/200（45.5%）：真实=1, 预测=1, √
样本92/200（46.0%）：真实=0, 预测=1, ×
样本93/200（46.5%）：真实=1, 预测=0, ×
样本94/200（47.0%）：真实=0, 预测=1, ×
样本95/200（47.5%）：真实=1, 预测=0, ×
样本96/200（48.0%）：真实=0, 预测=1, ×
样本97/200（48.5%）：真实=1, 预测=1, √
样本98/200（49.0%）：真实=0, 预测=1, ×
样本99/200（49.5%）：真实=1, 预测=0, ×
样本100/200（50.0%）：真实=0, 预测=1, ×
样本101/200（50.5%）：真实=1, 预测=1, √
样本102/200（51.0%）：真实=0, 预测=无, ×
样本103/200（51.5%）：真实=1, 预测=1, √
样本104/200（52.0%）：真实=0, 预测=0, √
样本105/200（52.5%）：真实=1, 预测=1, √
样本106/200（53.0%）：真实=0, 预测=1, ×
样本107/200（53.5%）：真实=1, 预测=1, √
样本108/200（54.0%）：真实=0, 预测=1, ×
样本109/200（54.5%）：真实=1, 预测=1, √
样本110/200（55.0%）：真实=0, 预测=1, ×
样本111/200（55.5%）：真实=1, 预测=1, √
样本112/200（56.0%）：真实=0, 预测=1, ×
样本113/200（56.5%）：真实=1, 预测=1, √
样本114/200（57.0%）：真实=0, 预测=1, ×
样本115/200（57.5%）：真实=1, 预测=1, √
样本116/200（58.0%）：真实=0, 预测=0, √
样本117/200（58.5%）：真实=1, 预测=1, √
样本118/200（59.0%）：真实=0, 预测=0, √
样本119/200（59.5%）：真实=1, 预测=1, √
样本120/200（60.0%）：真实=0, 预测=1, ×
样本121/200（60.5%）：真实=1, 预测=1, √
样本122/200（61.0%）：真实=0, 预测=1, ×
样本123/200（61.5%）：真实=1, 预测=1, √
样本124/200（62.0%）：真实=0, 预测=1, ×
样本125/200（62.5%）：真实=1, 预测=1, √
样本126/200（63.0%）：真实=0, 预测=1, ×
样本127/200（63.5%）：真实=1, 预测=1, √
样本128/200（64.0%）：真实=0, 预测=0, √
样本129/200（64.5%）：真实=1, 预测=1, √
样本130/200（65.0%）：真实=0, 预测=1, ×
样本131/200（65.5%）：真实=1, 预测=1, √
样本132/200（66.0%）：真实=0, 预测=1, ×
样本133/200（66.5%）：真实=1, 预测=1, √
样本134/200（67.0%）：真实=0, 预测=1, ×
样本135/200（67.5%）：真实=1, 预测=1, √
样本136/200（68.0%）：真实=0, 预测=1, ×
样本137/200（68.5%）：真实=1, 预测=1, √
样本138/200（69.0%）：真实=0, 预测=1, ×
样本139/200（69.5%）：真实=1, 预测=0, ×
样本140/200（70.0%）：真实=0, 预测=1, ×
样本141/200（70.5%）：真实=1, 预测=1, √
样本142/200（71.0%）：真实=0, 预测=1, ×
样本143/200（71.5%）：真实=1, 预测=1, √
样本144/200（72.0%）：真实=0, 预测=1, ×
样本145/200（72.5%）：真实=1, 预测=1, √
样本146/200（73.0%）：真实=0, 预测=1, ×
样本147/200（73.5%）：真实=1, 预测=1, √
样本148/200（74.0%）：真实=0, 预测=0, √
样本149/200（74.5%）：真实=1, 预测=1, √
样本150/200（75.0%）：真实=0, 预测=0, √
样本151/200（75.5%）：真实=1, 预测=1, √
样本152/200（76.0%）：真实=0, 预测=1, ×
样本153/200（76.5%）：真实=1, 预测=1, √
样本154/200（77.0%）：真实=0, 预测=1, ×
样本155/200（77.5%）：真实=1, 预测=1, √
样本156/200（78.0%）：真实=0, 预测=1, ×
样本157/200（78.5%）：真实=1, 预测=1, √
样本158/200（79.0%）：真实=0, 预测=0, √
样本159/200（79.5%）：真实=1, 预测=1, √
样本160/200（80.0%）：真实=0, 预测=1, ×
样本161/200（80.5%）：真实=1, 预测=1, √
样本162/200（81.0%）：真实=0, 预测=1, ×
^C样本163/200（81.5%）：真实=1, 预测=1, √
样本164/200（82.0%）：真实=0, 预测=1, ×
样本165/200（82.5%）：真实=1, 预测=1, √
样本166/200（83.0%）：真实=0, 预测=0, √
样本167/200（83.5%）：真实=1, 预测=1, √
样本168/200（84.0%）：真实=0, 预测=1, ×
样本169/200（84.5%）：真实=1, 预测=1, √
样本170/200（85.0%）：真实=0, 预测=1, ×
样本171/200（85.5%）：真实=1, 预测=1, √
样本172/200（86.0%）：真实=0, 预测=0, √
样本173/200（86.5%）：真实=1, 预测=1, √
样本174/200（87.0%）：真实=0, 预测=1, ×
样本175/200（87.5%）：真实=1, 预测=0, ×
样本176/200（88.0%）：真实=0, 预测=1, ×
样本177/200（88.5%）：真实=1, 预测=0, ×
样本178/200（89.0%）：真实=0, 预测=无, ×
