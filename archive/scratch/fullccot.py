...
- 逻辑验证：调用 ${PROJECT_ROOT}/../ChatLogic/pyDatalog_processing.py
...
USE_PREGEN_COT = True
PREGEN_JSONL = "${PROJECT_ROOT}/test_C-CoT/cot_generated_first10_flat_labeled.jsonl"

# 若需在线生成 CoT，配置 Qwen 与原始验证集路径
QWEN_DIR = "${MODEL_DIR}/../model_eval/modelscope_models/Qwen/Qwen-7B-Chat"
RAW_DEV_JSONL = "${PROJECT_ROOT}/../ChatLogic/PARARULE-Plus/Depth2/PARARULE_Plus_Depth2_shuffled_dev_huggingface.jsonl"
...
# 逻辑验证脚本
PYDATALOG_PATH = "${PROJECT_ROOT}/../ChatLogic/pyDatalog_processing.py"
