...
class ORMClassifier(nn.Module):
    def __init__(self, model_name="/home2/zzl/model/bert-base-uncased"):
        super().__init__()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="/home2/zzl/model/bert-base-uncased")
    parser.add_argument("--train_data", type=str, default="/home2/zzl/C-CoT/xiaorong/gsm8k_500_cot_qwen3.json")
