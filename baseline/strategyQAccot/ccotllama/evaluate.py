...
# 1. 路径配置
# =========================
MODEL_PATH = "/home2/zzl/C-CoT/baseline/strategyQAccot/ccotllama/outputs_llama/best_c_cot_encoder.pt"
TEST_PATH = "/home2/zzl/C-CoT/database/StrategyQA/strategyqa_test.json"
CORPUS_PATH = "/home2/zzl/C-CoT/database/StrategyQA/strategyqa_train.json"  # 假设训练集作为检索库
...
model = BertModel.from_pretrained('/home2/zzl/model/bert-base-uncased').to(DEVICE)
model.eval()
