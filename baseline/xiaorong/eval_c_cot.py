...
# 模型路径
LLAMA_PATH = "/home2/zzl/model/Llama-2-7b-chat-hf"
BERT_BASE = "/home2/zzl/model/bert-base-uncased"

# 模型映射：不同消融对应不同训练好的编码器
MODEL_MAP = {
    "full": "/home2/zzl/C-CoT/baseline/xiaorong/models/f_theta_full",
    "wo_contrastive": "/home2/zzl/C-CoT/baseline/xiaorong/models/f_theta_wo_con",
    "wo_multigranular": "/home2/zzl/C-CoT/baseline/xiaorong/modelsf_theta_wo_mg",
    "wo_consistency": "/home2/zzl/C-CoT/baseline/xiaorong/models/f_theta_wo_cs",
    "wo_dynamic_proto": "/home2/zzl/C-CoT/baseline/xiaorong/models/f_theta_full",  # 动态原型是推理策略
}
...
def main():
    ...
    # 加载数据
    questions, ground_truths = load_strategyqa("/home2/zzl/C-CoT/database/StrategyQA/strategyqa_train_filtered.json")
        # 只取前 500 条用于评测
